...
import { DEFAULT_SEAT_CONFIG } from "../lib/constants";
...
export default function AdminDashboard() {
  ...
  const [seatsPerRow, setSeatsPerRow] = useState(
    DEFAULT_SEAT_CONFIG.seatsPerRow,
  );
  const [aislePosition, setAislePosition] = useState(
    DEFAULT_SEAT_CONFIG.aislePosition,
  );
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    const premiumRows = [totalRows - 3, totalRows - 4, totalRows - 5].filter(
      (r) => r >= 0 && !vipRows.includes(r),
    );
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
      ...
      <section
        style={{
          background:
            "linear-gradient(180deg, var(--color-surface-2) 0%, transparent 100%)",
      ...
      >
        <div className='section-container'>
          <div className='flex items-center gap-3 mb-1'>
            <div
              className='w-9 h-9 rounded-xl gradient-brand flex items-center justify-center'
          ...
          <p style={{ color: "var(--color-text-muted)", fontSize: "0.9rem" }}>
            Create and manage events for tickets.
          </p>
        </div>
      </section>
      ...
      <div className='section-container py-8'>
        ...
        >
          ...
          >
            ...
            {error && (
              <div
                className='flex items-center gap-2 rounded-xl p-4 mb-5'
                style={{
            ...
            {success && (
              <div
                className='flex items-start gap-2 rounded-xl p-4 mb-5'
                style={{
                  ...
                  <div className='flex flex-col md:flex-row gap-4'>
                    <div className='flex flex-col gap-1.5 flex-1'>
                      ...
                      <input
                        ...
                        type='text'
                        className='input-base'
                        placeholder='e.g. PVR Cinema, Pune'
                        value={venue}
                  ...
                  <div className='flex flex-col md:flex-row gap-4'>
                    <div className='flex flex-col gap-1.5 flex-1'>
                      ...
                      <input
                        ...
                        type='text'
                        className='input-base'
                        placeholder='e.g. Concert, Comedy, Magic'
                        value={category}
                ...
                <div className='flex flex-col gap-4'>
                  <div className='flex flex-col md:flex-row gap-4'>
                    ...
                    <div className='flex flex-col gap-1.5 flex-1'>
                      ...
                      <input
                        ...
                        value={aislePosition}
                        onChange={(e) =>
                          setAislePosition(Number(e.target.value))
                        }
                        required
                      />
                    </div>
                  ...
                  >
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                      {[
                        {
                          id: "admin-regular-price",
                          label: "Regular",
                          value: regularPrice,
                          setter: setRegularPrice,
                          color: "var(--seat-regular)",
                        },
                        {
                          id: "admin-premium-price",
                          label: "Premium",
                          value: premiumPrice,
                    ...
                    >
                      Rows auto-split: bottom 2 = VIP, next 3 = Premium,
                      remaining = Regular
                    </p>
                  </div>
                </div>
          ...
          <div className='flex flex-col gap-4'>
            ...
            >
              ...
              >
                ...
                />
                <div
                  style={{ position: "relative", padding: "1rem", zIndex: 1 }}
                >
                  <p
                    style={{
                      color: "white",
                ...
                {!posterUrl && (
                  ...
                  >
                    <div style={{ textAlign: "center", opacity: 0.3 }}>
                      <ImageIcon
                        size={32}
                        style={{ color: "white", margin: "0 auto 0.5rem" }}
                      />
              ...
              <div className='flex flex-col gap-2'>
                {[
                  ...
                  {
                    label: "Regular seats",
                    value: `${Math.max(0, rows - 5)} rows × ₹${regularPrice}`,
                  },
                  {
                    label: "Premium seats",
                    value: `3 rows × ₹${premiumPrice}`,
                  },
